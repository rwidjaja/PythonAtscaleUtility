...
from tabs.aggregate_history_tab import build_tab as aggregate_history_tab
...
def main():
    ...
    make_tab_with_log(notebook, "Aggregate History", aggregate_history_tab, log6)
    ...
    append_log(log6[0], "Aggregate History ready.")
